...
```javascript
isEqual = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/complex-float64-base-assert-is-equal@v0.1.2-umd/browser.js' )
```
...
[test-image]: https://github.com/stdlib-js/complex-float64-base-assert-is-equal/actions/workflows/test.yml/badge.svg?branch=v0.1.2
[test-url]: https://github.com/stdlib-js/complex-float64-base-assert-is-equal/actions/workflows/test.yml?query=branch:v0.1.2
